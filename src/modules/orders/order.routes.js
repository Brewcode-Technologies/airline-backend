...
const { getOrders, getOrder, createOrder, updateOrder, deleteOrder, assignDriver, updateStatus, setPicked, setEnroute, setDelivered, verifyOtp } = require('./order.controller');
...
router.delete('/:id', roleMiddleware('admin', 'airline'), deleteOrder);
